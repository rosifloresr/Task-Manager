...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "apps/auth-service/src/prisma/client",
    "auth-service/src/prisma/client",
  ]
...
path.join(process.cwd(), "apps/auth-service/src/prisma/client/libquery_engine-darwin.dylib.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "apps/auth-service/src/prisma/client/schema.prisma")
